...
class TreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tree" do
    assert_difference('Tree.count') do
      post trees_url, params: { tree: { age: @tree.age, leaftype: @tree.leaftype, wood: @tree.wood } }
    end
  ...
  test "should update tree" do
    patch tree_url(@tree), params: { tree: { age: @tree.age, leaftype: @tree.leaftype, wood: @tree.wood } }
